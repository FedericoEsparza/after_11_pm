 ...
 #
  describe '#expand' do
    ...
    it 'expands (x+y)(x+y)(x+y)' do
      ...
      expect(result[0]).to eq '(x+y)(x+y)(x+y)'.objectify
      expect(result[1]).to eq '(xx+xy+yx+yy)(x+y)'.objectify
      expect(result[2]).to eq '(xx+xy+xy+yy)(x+y)'.objectify
      expect(result[3]).to eq '(x^1x^1+xy+xy+y^1y^1)(x+y)'.objectify
      expect(result[4]).to eq '(x^{1+1}+xy+xy+y^{1+1})(x+y)'.objectify
      expect(result[5]).to eq '(x^2+xy+xy+y^2)(x+y)'.objectify
      expect(result[6]).to eq '(x^2+2xy+y^2)(x+y)'.objectify
      expect(result[7]).to eq 'x^2x+x^2y+2xyx+2xyy+y^2x+y^2y'.objectify
      expect(result[8]).to eq 'x^2x+x^2y+2xxy+2xyy+xy^2+y^2y'.objectify
      expect(result[9]).to eq 'x^2x^1+x^2y+2x^1x^1y+2xy^1y^1+xy^2+y^2y^1'.objectify
      expect(result[10]).to eq 'x^{2+1}+x^2y+2x^{1+1}y+2xy^{1+1}+xy^2+y^{2+1}'.objectify
      expect(result[11]).to eq 'x^3+x^2y+2x^2y+2xy^2+xy^2+y^3'.objectify
      expect(result[12]).to eq 'x^3+3x^2y+3xy^2+y^3'.objectify
    ...
    it 'expands (a+b)^3' do
      ...
      #   end
        ...
        expect(result[2]).to eq '(aa+ab+ab+bb)(a+b)'.objectify
        expect(result[3]).to eq '(a^1a^1+ab+ab+b^1b^1)(a+b)'.objectify
        expect(result[4]).to eq '(a^{1+1}+ab+ab+b^{1+1})(a+b)'.objectify
        ...
        expect(result[8]).to eq 'a^2a+a^2b+2aab+2abb+ab^2+b^2b'.objectify
        expect(result[9]).to eq 'a^2a^1+a^2b+2a^1a^1b+2ab^1b^1+ab^2+b^2b^1'.objectify
        expect(result[10]).to eq 'a^{2+1}+a^2b+2a^{1+1}b+2ab^{1+1}+ab^2+b^{2+1}'.objectify
        expect(result[11]).to eq 'a^3+a^2b+2a^2b+2ab^2+ab^2+b^3'.objectify
        expect(result[12]).to eq 'a^3+3a^2b+3ab^2+b^3'.objectify
  ...
  describe '#refactored combine brackets' do
    xit 'combine (x+y)(x+z)' do
      ...
      result = exp.expand
        ...
        expect(result[3]).to eq 'x^1x^1+xz+xy+yz'.objectify
        expect(result[4]).to eq 'x^{1+1}+xz+xy+yz'.objectify
        expect(result[5]).to eq 'x^2+xz+xy+yz'.objectify
